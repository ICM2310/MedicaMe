...
import javeriana.edu.co.medicameapp.databinding.ActivityReservaExitosaaBinding

class ReservaExitosaa : AppCompatActivity(), OnMapReadyCallback {

    private lateinit var mMap: GoogleMap
    private lateinit var binding: ActivityReservaExitosaaBinding

    override fun onCreate(savedInstanceState: Bundle?)
    {
        super.onCreate(savedInstanceState)

        binding = ActivityReservaExitosaaBinding.inflate(layoutInflater)
    ...
    private fun initializeElements()
    {
        binding.ButtonRetroceder.setOnClickListener {
            Log.i("Reserva Exitosa", "Boton de back accionado")
            finish()
        }
    }
